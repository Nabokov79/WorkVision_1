...
import ru.nabokovsg.measurementNK.mapper.norms.DefectMapper;
import ru.nabokovsg.measurementNK.model.norms.ActionsOnParameter;
import ru.nabokovsg.measurementNK.model.norms.Defect;
import ru.nabokovsg.measurementNK.repository.norms.DefectRepository;
...
public class DefectServiceImpl implements DefectService {
    ...
    public ResponseDefectDto get(Long id) {
        return mapper.mapToResponseDefectDto(repository.findById(id)
