...
import ru.nabokovsg.laboratoryNK.mapper.template.DocumentHeaderMapper;
...
import ru.nabokovsg.laboratoryNK.repository.template.DocumentHeaderRepository;
...
public class DocumentHeaderServiceImpl implements DocumentHeaderService {
    ...
    @Override
    public ResponseDocumentHeaderDto save(DocumentHeaderDto headerDto) {
    ...
    @Override
    public ResponseDocumentHeaderDto update(DocumentHeaderDto headerDto) {
    ...
    @Override
    public List<ResponseDocumentHeaderDto> getAll(Long id) {
    ...
    @Override
    public Set<DocumentHeader> getAllByDocumentTypeId(Long documentTypeId) {
        Set<DocumentHeader> documentHeaders = repository.findAllByDocumentTypeId(documentTypeId);
    ...
    private DocumentHeader create(DocumentHeaderDto headerDto, DivisionType divisionType) {
