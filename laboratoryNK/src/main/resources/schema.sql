...
(
    ...
    CONSTRAINT UQ_DOCUMENT_TYPES UNIQUE (title, heading, type_document)
);
...
(
    ...
    CONSTRAINT FK_DIAGNOSTIC_DOCUMENT_ON_DOCUMENT_TYPES FOREIGN KEY (document_type_id) REFERENCES document_types (id)
);
