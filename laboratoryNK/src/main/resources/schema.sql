...
(
    ...
    CONSTRAINT UQ_PROTOCOL_TEMPLATES UNIQUE (document_type_id, equipment_type_id),
    CONSTRAINT FK_PROTOCOL_TEMPLATES_ON_CONCLUSION_TEMPLATES
        FOREIGN KEY (conclusion_template_id) REFERENCES conclusion_templates (id)
);

CREATE TABLE IF NOT EXISTS PROTOCOL_TEMPLATES_DOCUMENT_HEADERS
(
...
(
    ...
    CONSTRAINT FK_APPENDICES_ON_REPORT_TEMPLATES FOREIGN KEY (report_template_id) REFERENCES report_templates (id)
);