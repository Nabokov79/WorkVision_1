...
@RestController
@RequestMapping(
        value = "/WorkVisionWeb/subsection",
...
public class SubsectionTemplateController {
    ...
    @PostMapping
    public Mono<Object> saveWithUseText(@RequestBody @Valid@Parameter(description = "Шаблон подраздела")
                                                                NewSubsectionWithUseTextTemplateDto subsectionsDto) {
        return client.saveWithUseText(subsectionsDto);
    }

    @Operation(summary = "Изменение данных шаблона подраздела c текстом пользователя")
    @PatchMapping
    public Mono<Object> updateWithUseText(@RequestBody @Valid @Parameter(description = "Шаблон подраздела")
                                                             UpdateSubsectionWithUseTextTemplateDto subsectionsDto) {
        return client.updateWithUseText(subsectionsDto);
    }
