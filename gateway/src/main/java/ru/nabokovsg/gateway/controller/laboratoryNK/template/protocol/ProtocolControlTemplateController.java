...
import ru.nabokovsg.gateway.client.laboratoryNK.template.protocol.ProtocolControlTemplateClient;
...
@RestController
@RequestMapping(
        value = "/WorkVisionWeb/laboratory/nk/template/protocol/control",
