package ru.nabokovsg.gateway.dto.laboratoryNK.documentHeader;
...
@Getter
@AllArgsConstructor
@Schema(description = "Данные для изменения заголовка протокола")
public class UpdateDocumentHeaderForProtocolDto {
