...
@Getter
@AllArgsConstructor
@Schema(description = "Данные для изменения шаблона подраздела c таблицей")
public class UpdateSubsectionWithTableTemplateDto {
    ...
    @Positive(message = "table id can only be positive")
